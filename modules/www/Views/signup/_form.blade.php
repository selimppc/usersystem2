        ...
        <div class="col-md-12">
            ...
            <div class="hpanel">
                <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'com-signup','id'=>'form_2']) !!}
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                {!! Form::text('company_name', Input::old('company_name'), ['id'=>'company_name','class' => 'form-control','required','placeholder'=>'Company Name','title'=>'Enter Company Address']) !!}
                            </div>
